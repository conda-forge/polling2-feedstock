...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/polling2-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14349&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/polling2-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `polling2` can be installed with:

```
conda install polling2
```

It is possible to list all of the versions of `polling2` available on your platform with:
